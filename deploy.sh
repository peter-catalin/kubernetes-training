...
echo About to build and tag images ...
...
docker build -t petercatalin/docker-training-multi-worker:latest -t petercatalin/docker-training-multi-worker:$SHA -f ./worker/Dockerfile ./worker
echo Images have been created and tagged

# Once the images are successfully generated we need to push them to DockerHub.
echo Pushing images as latest ...
...
echo Images have been pushed

echo Pushing images with SHA as tag ...
